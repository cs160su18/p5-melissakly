...
class GoalsForm(forms.Form):
    goal = forms.CharField(label="Enter your goal for the week.", max_length=20)
...
class EarnForm(forms.Form):
    name = forms.CharField(label="Enter the item's name.", max_length=20)
    amount = forms.DecimalField(label="Enter amount earned.")
    description = forms.CharField(label="Enter the description of earnings.", max_length=200)


class SpendForm(forms.Form):
    name = forms.CharField(label="Enter the item's name.", max_length=20)
    cost = forms.DecimalField(label="Enter the item's price.")
    description = forms.CharField(label="Enter the description of spendings.", max_length=200)
